!function (e, t) {
    ...
    function s() {
        _.removeEventListener("DOMContentLoaded", s), e.removeEventListener("load", s), oe.ready()
    }
    ...
    function p(e, t, n, r, i) {
        for (var o, s, a, u, l, p, d = t.createDocumentFragment(), h = [], g = 0,
                 m = e.length; m > g; g++)if (o = e[g], o || 0 === o)if ("object" === oe.type(o)) oe.merge(h, o.nodeType ? [o] : o); else if (Oe.test(o)) {
            for (s = s || d.appendChild(t.createElement("div")), a = (He.exec(o) || ["", ""])[1].toLowerCase(), u = Ie[a] || Ie._default, s.innerHTML = u[1] + oe.htmlPrefilter(o) + u[2], p = u[0]; p--;)s = s.lastChild;
            oe.merge(h, s.childNodes), s = d.firstChild, s.textContent = ""
        } else h.push(t.createTextNode(o));
        for (d.textContent = "", g = 0; o = h[g++];)if (r && oe.inArray(o, r) > -1) i && i.push(o); else if (l = oe.contains(o.ownerDocument, o), s = c(d.appendChild(o), "script"), l && f(s), n)for (p = 0; o = s[p++];)Pe.test(o.type || "") && n.push(o);
        return d
    }
    ...
    function T(e, t, n, r) {
        ...
        if (m || d > 1 && "string" == typeof g && !re.checkClone && ze.test(g))return e.each(function (i) {
            var o = e.eq(i);
        ...
        if (d && (i = p(t, e[0].ownerDocument, !1, e, r), o = i.firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
            ...
            if (a)for (l = s[s.length - 1].ownerDocument, oe.map(s, b), f = 0; a > f; f++)u = s[f], Pe.test(u.type || "") && !je.access(u, "globalEval") && oe.contains(l, u) && (u.src ? oe._evalUrl && oe._evalUrl(u.src) : oe.globalEval(u.textContent.replace(Ue, "")))
        }
        return e
    }

    function C(e, t, n) {
        for (var r, i = t ? oe.filter(t, e) : e,
                 o = 0; null != (r = i[o]); o++)n || 1 !== r.nodeType || oe.cleanData(c(r)), r.parentNode && (n && oe.contains(r.ownerDocument, r) && f(c(r, "script")), r.parentNode.removeChild(r));
        return e
    }
    ...
    function j(e) {
        var t = _, n = Ye[e];
        return n || (n = k(e, t), "none" !== n && n || (Ve = (Ve || oe("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = Ve[0].contentDocument, t.write(), t.close(), n = k(e, t), Ve.detach()), Ye[e] = n), n
    }

    function E(e, t, n) {
        var r, i, o, s, a = e.style;
        return n = n || Je(e), s = n ? n.getPropertyValue(t) || n[t] : void 0, "" !== s && void 0 !== s || oe.contains(e.ownerDocument, e) || (s = oe.style(e, t)), n && !re.pixelMarginRight() && _e.test(s) && Ge.test(t) && (r = a.width, i = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = r, a.minWidth = i, a.maxWidth = o), void 0 !== s ? s + "" : s
    }
    ...
    function A(e, t, n, r, i) {
        for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0,
                 s = 0; 4 > o; o += 2)"margin" === n && (s += oe.css(e, n + qe[o], !0, i)), r ? ("content" === n && (s -= oe.css(e, "padding" + qe[o], !0, i)), "margin" !== n && (s -= oe.css(e, "border" + qe[o] + "Width", !0, i))) : (s += oe.css(e, "padding" + qe[o], !0, i), "padding" !== n && (s += oe.css(e, "border" + qe[o] + "Width", !0, i)));
        return s
    }

    function q(t, n, r) {
        var i = !0, o = "width" === n ? t.offsetWidth : t.offsetHeight, s = Je(t),
            a = "border-box" === oe.css(t, "boxSizing", !1, s);
        if (_.msFullscreenElement && e.top !== e && t.getClientRects().length && (o = Math.round(100 * t.getBoundingClientRect()[n])), 0 >= o || null == o) {
            if (o = E(t, n, s), (0 > o || null == o) && (o = t.style[n]), _e.test(o))return o;
    ...
    function $(e, t) {
        for (var n, r, i, o = [], s = 0,
                 a = e.length; a > s; s++)r = e[s], r.style && (o[s] = je.get(r, "olddisplay"), n = r.style.display, t ? (o[s] || "none" !== n || (r.style.display = ""), "" === r.style.display && $e(r) && (o[s] = je.access(r, "olddisplay", j(r.nodeName)))) : (i = $e(r), "none" === n && i || je.set(r, "olddisplay", i ? n : oe.css(r, "display"))));
    ...
    function I(e, t, n) {
        for (var r, i = (M.tweeners[t] || []).concat(M.tweeners["*"]), o = 0,
                 s = i.length; s > o; o++)if (r = i[o].call(n, t, e))return r
    }

    function O(e, t, n) {
        var r, i, o, s, a, u, l, c, f = this, p = {}, d = e.style, h = e.nodeType && $e(e), g = je.get(e, "fxshow");
        ...
        if (oe.isEmptyObject(p)) "inline" === ("none" === l ? j(e.nodeName) : l) && (d.display = l); else {
    ...
    function M(e, t, n) {
        var r, i, o = 0, s = M.prefilters.length, a = oe.Deferred().always(function () {
            ...
            if (i)return !1;
            for (var t = it || H(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, o = 1 - r,
        ...
        for (F(c, l.opts.specialEasing); s > o; o++)if (r = M.prefilters[o].call(l, e, c, l.opts))return oe.isFunction(r.stop) && (oe._queueHooks(l.elem, l.opts.queue).stop = oe.proxy(r.stop, r)), r;
    ...
    function V(e, t, n, r) {
        ...
        }); else if (n || "object" !== oe.type(t)) r(e, t); else for (i in t)V(e + "[" + i + "]", t[i], n, r)
    }
    ...
    var G = [], _ = e.document, J = G.slice, Q = G.concat, K = G.push, Z = G.indexOf, ee = {}, te = ee.toString,
        ne = ee.hasOwnProperty, re = {}, ie = "2.2.1", oe = function (e, t) {
    ...
    oe.fn = oe.prototype = {
        ...
        expando: "jQuery" + (ie + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (e) {
            ...
            var t, n = eval;
            e = oe.trim(e), e && (1 === e.indexOf("use strict") ? (t = _.createElement("script"), t.text = e, _.head.appendChild(t).parentNode.removeChild(t)) : n(e))
    ...
    var ce = function (e) {
        function t(e, t, n, r) {
            ...
            if (!r && ((t ? t.ownerDocument || t : R) !== $ && q(t), t = t || $, H)) {
                ...
                if (w.qsa && !U[e + " "] && (!P || !P.test(e))) {
                    if (1 !== g) h = t, d = e; else if ("object" !== t.nodeName.toLowerCase()) {
                        for ((a = t.getAttribute("id")) ? a = a.replace(be, "\\$&") : t.setAttribute("id", a = M), f = j(e), o = f.length, u = pe.test(a) ? "#" + a : "[id='" + a + "']"; o--;)f[o] = u + " " + p(f[o]);
        ...
        function v(e, t, n, i, o, s) {
            return i && !i[M] && (i = v(i)), o && !o[M] && (o = v(o, s)), r(function (r, s, a, u) {
                var l, c, f, p = [], d = [], h = s.length, v = r || g(t || "*", a.nodeType ? [a] : a, []),
                    y = !e || !r && t ? v : m(v, p, e, a, u), b = n ? o || (r ? e : h || i) ? [] : s : y;
                if (n && n(y, b, a, u), i)for (l = m(b, d), i(l, [], a, u), c = l.length; c--;)(f = l[c]) && (b[d[c]] = !(y[d[c]] = f));
                if (r) {
                    if (o || e) {
                        if (o) {
                        ...
                        for (c = b.length; c--;)(f = b[c]) && (l = o ? ee(r, f) : p[c]) > -1 && (r[l] = !(s[l] = f))
                    }
        ...
        function b(e, n) {
            var i = n.length > 0, o = e.length > 0, s = function (r, s, a, u, l) {
                var c, f, p, d = 0, h = "0", g = r && [], v = [], y = D, b = r || o && T.find.TAG("*", l),
                    x = W += null == y ? 1 : Math.random() || .1, w = b.length;
                for (l && (D = s === $ || s || l); h !== w && null != (c = b[h]); h++) {
                    if (o && c) {
                        for (f = 0, s || c.ownerDocument === $ || (q(c), a = !H); p = e[f++];)if (p(c, s || $, a)) {
                            u.push(c);
                            break
                        }
                        l && (W = x)
        ...
        var x, w, T, C, k, j, E, S, D, N, A, q, $, L, H, P, I, O, F, M = "sizzle" + 1 * new Date, R = e.document, W = 0,
            B = 0, z = n(), X = n(), U = n(), V = function (e, t) {
                return e === t && (A = !0), 0
            }, Y = 1 << 31, G = {}.hasOwnProperty, _ = [], J = _.pop, Q = _.push, K = _.push, Z = _.slice,
            ee = function (e, t) {
        ...
        try {
            K.apply(_ = Z.call(R.childNodes), R.childNodes), _[R.childNodes.length].nodeType
        } catch (e) {
            K = {
        ...
        w = t.support = {}, k = t.isXML = function (e) {
            ...
            return r !== $ && 9 === r.nodeType && r.documentElement ? ($ = r, L = $.documentElement, H = !k($), (n = $.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Te, !1) : n.attachEvent && n.attachEvent("onunload", Te)), w.attributes = i(function (e) {
                ...
                return L.appendChild(e).id = M, !$.getElementsByName || !$.getElementsByName(M).length
                ...
                }, I = [], P = [], (w.qsa = me.test($.querySelectorAll)) && (i(function (e) {
            ...
            })), (w.matchesSelector = me.test(O = L.matches || L.webkitMatchesSelector || L.mozMatchesSelector || L.oMatchesSelector || L.msMatchesSelector)) && i(function (e) {
                w.disconnectedMatch = O.call(e, "div"), O.call(e, "[s!='']:x"), I.push("!=", oe)
            }), P = P.length && new RegExp(P.join("|")), I = I.length && new RegExp(I.join("|")), t = me.test(L.compareDocumentPosition), F = t || me.test(L.contains) ? function (e, t) {
                ...
                return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === $ || e.ownerDocument === R && F(R, e) ? -1 : t === $ || t.ownerDocument === R && F(R, t) ? 1 : N ? ee(N, e) - ee(N, t) : 0 : 4 & n ? -1 : 1)
            } : function (e, t) {
                if (e === t)return A = !0, 0;
            ...
            if ((e.ownerDocument || e) !== $ && q(e), n = n.replace(ce, "='$1']"), w.matchesSelector && H && !U[n + " "] && (!I || !I.test(n)) && (!P || !P.test(n)))try {
                var r = O.call(e, n);
            ...
            return (e.ownerDocument || e) !== $ && q(e), F(e, t)
        }, t.attr = function (e, t) {
                    ...
                    return 1 === r && 0 === i ? function (e) {
                        ...
                        if (m) {
                            ...
                            if (h = [s ? m.firstChild : m.lastChild], s && y) {
                                for (p = m, f = p[M] || (p[M] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), l = c[e] || [], d = l[0] === W && l[1], b = d && l[2], p = d && m.childNodes[d]; p = ++d && p && p[g] || (b = d = 0) || h.pop();)if (1 === p.nodeType && ++b && p === t) {
                                    c[e] = [W, d, b];
                                    break
                                }
                            } else if (y && (p = t, f = p[M] || (p[M] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), l = c[e] || [], d = l[0] === W && l[1], b = d), b === !1)for (; (p = ++d && p && p[g] || (b = d = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++b || (y && (f = p[M] || (p[M] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), c[e] = [W, b]), p !== t)););
        ...
        return f.prototype = T.filters = T.pseudos, T.setFilters = new f, j = t.tokenize = function (e, n) {
            ...
            var n, r = [], i = [], o = U[e + " "];
            if (!o) {
                for (t || (t = j(e)), n = t.length; n--;)o = y(t[n]), o[M] ? r.push(o) : i.push(o);
                o = U(e, b(i, r)), o.selector = e
            }
            return o
        }, S = t.select = function (e, t, n, r) {
            var i, o, s, a, u, l = "function" == typeof e && e, f = !r && j(e = l.selector || e);
            if (n = n || [], 1 === f.length) {
                ...
                for (i = de.needsContext.test(e) ? 0 : o.length; i-- && (s = o[i], !T.relative[a = s.type]);)if ((u = T.find[a]) && (r = u(s.matches[0].replace(xe, we), ye.test(o[0].type) && c(t.parentNode) || t))) {
                    if (o.splice(i, 1), e = r.length && p(o), !e)return K.apply(n, r), n;
                    break
                }
            }
            return (l || E(e, f))(r, t, !H, n, !t || ye.test(e) && c(t.parentNode) || t), n
        }, w.sortStable = M.split("").sort(V).join("") === M, w.detectDuplicates = !!A, q(), w.sortDetached = i(function (e) {
    ...
    var me, ve = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, ye = oe.fn.init = function (e, t, n) {
        ...
        if (n = n || me, "string" == typeof e) {
            ...
            if (r[1]) {
                if (t = t instanceof oe ? t[0] : t, oe.merge(this, oe.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : _, !0)), he.test(r[1]) && oe.isPlainObject(t))for (r in t)oe.isFunction(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
                return this
            }
            return i = _.getElementById(r[2]), i && i.parentNode && (this.length = 1, this[0] = i), this.context = _, this.selector = e, this
        }
    ...
    oe.fn.extend({
        has: function (e) {
            ...
            for (var n, r = 0, i = this.length, o = [],
                     s = de.test(e) || "string" != typeof e ? oe(e, t || this.context) : 0; i > r; r++)for (n = this[r]; n && n !== t; n = n.parentNode)if (n.nodeType < 11 && (s ? s.index(n) > -1 : 1 === n.nodeType && oe.find.matchesSelector(n, e))) {
                o.push(n);
                break
            }
    ...
    oe.Callbacks = function (e) {
        ...
        Deferred: function (e) {
            ...
            var t, n, r, i = 0, o = J.call(arguments), s = o.length,
    ...
    oe.fn.ready = function (e) {
        ...
        isReady: !1, readyWait: 1, holdReady: function (e) {
            ...
            (e === !0 ? --oe.readyWait : oe.isReady) || (oe.isReady = !0, e !== !0 && --oe.readyWait > 0 || (Te.resolveWith(_, [oe]), oe.fn.triggerHandler && (oe(_).triggerHandler("ready"), oe(_).off("ready"))))
        }
    }), oe.ready.promise = function (t) {
        return Te || (Te = oe.Deferred(), "complete" === _.readyState || "loading" !== _.readyState && !_.documentElement.doScroll ? e.setTimeout(oe.ready) : (_.addEventListener("DOMContentLoaded", s), e.addEventListener("load", s))), Te.promise(t)
    }, oe.ready.promise();
    ...
    var je = new a, Ee = new a, Se = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, De = /[A-Z]/g;
    oe.extend({
        hasData: function (e) {
            return Ee.hasData(e) || je.hasData(e)
        }, data: function (e, t, n) {
        ...
        data: function (e, t) {
            ...
            if (void 0 === e) {
                if (this.length && (i = Ee.get(o), 1 === o.nodeType && !je.get(o, "hasDataAttrs"))) {
            ...
            return "object" == typeof e ? this.each(function () {
                ...
                var n, r;
                if (o && void 0 === t) {
                    if (n = Ee.get(o, e) || Ee.get(o, e.replace(De, "-$&").toLowerCase()), void 0 !== n)return n;
    ...
    var Ne = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, Ae = new RegExp("^(?:([+-])=|)(" + Ne + ")([a-z%]*)$", "i"),
        qe = ["Top", "Right", "Bottom", "Left"], $e = function (e, t) {
            return e = t || e, "none" === oe.css(e, "display") || !oe.contains(e.ownerDocument, e)
        }, Le = /^(?:checkbox|radio)$/i, He = /<([\w:-]+)/, Pe = /^$|\/(?:java|ecma)script/i, Ie = {
    ...
    var Oe = /<|&#?\w+;/;
    !function () {
        var e = _.createDocumentFragment(), t = e.appendChild(_.createElement("div")), n = _.createElement("input");
    ...
    var Fe = /^key/, Me = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, Re = /^([^.]*)(?:\.(.+)|)/;
    oe.event = {
        global: {},
        add: function (e, t, n, r, i) {
            var o, s, a, u, l, c, f, p, d, h, g, m = je.get(e);
            if (m)for (n.handler && (o = n, n = o.handler, i = o.selector), n.guid || (n.guid = oe.guid++), (u = m.events) || (u = m.events = {}), (s = m.handle) || (s = m.handle = function (t) {
        ...
        remove: function (e, t, n, r, i) {
            ...
            if (m && (u = m.events)) {
                for (t = (t || "").match(we) || [""], l = t.length; l--;)if (a = Re.exec(t[l]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d) {
        ...
        dispatch: function (e) {
            e = oe.event.fix(e);
            var t, n, r, i, o, s = [], a = J.call(arguments), u = (je.get(this, "events") || {})[e.type] || [],
        ...
        fix: function (e) {
            ...
            for (s || (this.fixHooks[i] = s = Me.test(i) ? this.mouseHooks : Fe.test(i) ? this.keyHooks : {}), r = s.props ? this.props.concat(s.props) : this.props, e = new oe.Event(o), t = r.length; t--;)n = r[t], e[n] = o[n];
            return e.target || (e.target = _), 3 === e.target.nodeType && (e.target = e.target.parentNode), s.filter ? s.filter(e, o) : e
        },
        special: {
    ...
    var We = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi, Be = /<script|<style|<link/i,
        ze = /checked\s*(?:[^=]|=\s*.checked.)/i, Xe = /^true\/(.*)/, Ue = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
    oe.extend({
        htmlPrefilter: function (e) {
            ...
            if (t)if (n)for (o = o || c(e), s = s || c(a), r = 0, i = o.length; i > r; r++)x(o[r], s[r]); else x(e, a);
        ...
        domManip: T, detach: function (e) {
            ...
            for (var e,
                     t = 0; null != (e = this[t]); t++)1 === e.nodeType && (oe.cleanData(c(e, !1)), e.textContent = "");
            return this
        }, clone: function (e, t) {
            ...
            return Ce(this, function (e) {
                ...
                if ("string" == typeof e && !Be.test(e) && !Ie[(He.exec(e) || ["", ""])[1].toLowerCase()]) {
        ...
        oe.fn[e] = function (e) {
            for (var n, r = [], i = oe(e), o = i.length - 1,
                     s = 0; o >= s; s++)n = s === o ? this : this.clone(!0), oe(i[s])[t](n), K.apply(r, n.get());
            return this.pushStack(r)
        }
    });
    var Ve, Ye = {HTML: "block", BODY: "block"}, Ge = /^margin/, _e = new RegExp("^(" + Ne + ")(?!px)[a-z%]+$", "i"),
        Je = function (t) {
    ...
    !function () {
        ...
        var n, r, i, o, s = _.createElement("div"), a = _.createElement("div");
        a.style && (a.style.backgroundClip = "content-box", a.cloneNode(!0).style.backgroundClip = "", re.clearCloneStyle = "content-box" === a.style.backgroundClip, s.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", s.appendChild(a), oe.extend(re, {
            pixelPosition: function () {
                ...
                var t, n = a.appendChild(_.createElement("div"));
    ...
    oe.extend({
        ...
        css: function (e, t, n, r) {
            ...
            return t = oe.cssProps[a] || (oe.cssProps[a] = D(a) || a), s = oe.cssHooks[t] || oe.cssHooks[a], s && "get" in s && (i = s.get(e, !0, n)), void 0 === i && (i = E(e, t, r)), "normal" === i && t in tt && (i = tt[t]), "" === n || n ? (o = parseFloat(i), n === !0 || isFinite(o) ? o || 0 : i) : i
        }
        ...
        oe.cssHooks[t] = {
            get: function (e, n, r) {
                ...
                var i, o = r && Je(e), s = r && A(e, t, r, "border-box" === oe.css(e, "boxSizing", !1, o), o);
                return s && (i = Ae.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n, n = oe.css(e, t)), N(e, n, s)
            }
        }
        ...
        }, Ge.test(e) || (oe.cssHooks[e + t].set = N)
    }), oe.fn.extend({
        css: function (e, t) {
    ...
    oe.Animation = oe.extend(M, {
        tweeners: {
            ...
            for (var n, r = 0,
                     i = e.length; i > r; r++)n = e[r], M.tweeners[n] = M.tweeners[n] || [], M.tweeners[n].unshift(t)
        ...
        fadeTo: function (e, t, n, r) {
            ...
            return "string" != typeof e && (n = t, t = e, e = void 0), t && e !== !1 && this.queue(e || "fx", []), this.each(function () {
                var t = !0, i = null != e && e + "queueHooks", o = oe.timers, s = je.get(this);
            ...
            return e !== !1 && (e = e || "fx"), this.each(function () {
                var t, n = je.get(this), r = n[e + "queue"], i = n[e + "queueHooks"], o = oe.timers,
                    s = r ? r.length : 0;
        ...
        var e = _.createElement("input"), t = _.createElement("select"), n = t.appendChild(_.createElement("option"));
        e.type = "checkbox", re.checkOn = "" !== e.value, re.optSelected = n.selected, t.disabled = !0, re.optDisabled = !n.disabled, e = _.createElement("input"), e.value = "t", e.type = "radio", re.radioValue = "t" === e.value
    }();
    ...
    oe.fn.extend({
        addClass: function (e) {
            ...
            if ("string" == typeof e && e)for (t = e.match(we) || []; n = this[u++];)if (i = R(n), r = 1 === n.nodeType && (" " + i + " ").replace(pt, " ")) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : oe.isFunction(e) ? this.each(function (n) {
                ...
                var t, r, i, o;
                if ("string" === n)for (r = 0, i = oe(this), o = e.match(we) || []; t = o[r++];)i.hasClass(t) ? i.removeClass(t) : i.addClass(t); else(void 0 === e || "boolean" === n) && (t = R(this), t && je.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || e === !1 ? "" : je.get(this, "__className__") || ""))
            })
        }, hasClass: function (e) {
            var t, n, r = 0;
            for (t = " " + e + " "; n = this[r++];)if (1 === n.nodeType && (" " + R(n) + " ").replace(pt, " ").indexOf(t) > -1)return !0;
            return !1
        }
    });
    var dt = /\r/g;
            ...
            option: {
                ...
                get: function (e) {
                    for (var t, n, r = e.options, i = e.selectedIndex, o = "select-one" === e.type || 0 > i,
                             ...
                             u = 0 > i ? a : o ? i : 0; a > u; u++)if (n = r[u], (n.selected || u === i) && (re.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !oe.nodeName(n.parentNode, "optgroup"))) {
                        if (t = oe(n).val(), o)return t;
                        s.push(t)
                    }
                    return s
                }, set: function (e, t) {
                    for (var n, r, i = e.options, o = oe.makeArray(t),
                             s = i.length; s--;)r = i[s], (r.selected = oe.inArray(oe.valHooks.option.get(r), o) > -1) && (n = !0);
    ...
    oe.extend(oe.event, {
        trigger: function (t, n, r, i) {
            var o, s, a, u, l, c, f, p = [r || _], d = ne.call(t, "type") ? t.type : t,
                h = ne.call(t, "namespace") ? t.namespace.split(".") : [];
            if (s = a = r = r || _, 3 !== r.nodeType && 8 !== r.nodeType && !ht.test(d + oe.event.triggered) && (d.indexOf(".") > -1 && (h = d.split("."), d = h.shift(), h.sort()), l = d.indexOf(":") < 0 && "on" + d, t = t[oe.expando] ? t : new oe.Event(d, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : oe.makeArray(n, [t]), f = oe.event.special[d] || {}, i || !f.trigger || f.trigger.apply(r, n) !== !1)) {
                if (!i && !f.noBubble && !oe.isWindow(r)) {
                    for (u = f.delegateType || d, ht.test(u + d) || (s = s.parentNode); s; s = s.parentNode)p.push(s), a = s;
                    a === (r.ownerDocument || _) && p.push(a.defaultView || a.parentWindow || e)
                }
                for (o = 0; (s = p[o++]) && !t.isPropagationStopped();)t.type = o > 1 ? u : f.bindType || d, c = (je.get(s, "events") || {})[t.type] && je.get(s, "handle"), c && c.apply(s, n), c = l && s[l], c && c.apply && ke(s) && (t.result = c.apply(s, n), t.result === !1 && t.preventDefault());
    ...
    var yt = /#.*$/, bt = /([?&])_=[^&]*/, xt = /^(.*?):[ \t]*([^\r\n]*)$/gm,
        wt = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Tt = /^(?:GET|HEAD)$/, Ct = /^\/\//, kt = {},
        jt = {}, Et = "*/".concat("*"), St = _.createElement("a");
    St.href = gt.href, oe.extend({
        ...
        ajax: function (t, n) {
            function r(t, n, r, a) {
                var l, f, y, b, w, C = n;
                2 !== x && (x = 2, u && e.clearTimeout(u), i = void 0, s = a || "", T.readyState = t > 0 ? 4 : 0, l = t >= 200 && 300 > t || 304 === t, r && (b = X(p, T, r)), b = U(p, b, T, l), l ? (p.ifModified && (w = T.getResponseHeader("Last-Modified"), w && (oe.lastModified[o] = w), w = T.getResponseHeader("etag"), w && (oe.etag[o] = w)), 204 === t || "HEAD" === p.type ? C = "nocontent" : 304 === t ? C = "notmodified" : (C = b.state, f = b.data, y = b.error, l = !y)) : (y = C, (t || !C) && (C = "error", 0 > t && (t = 0))), T.status = t, T.statusText = (n || C) + "", l ? g.resolveWith(d, [f, C, T]) : g.rejectWith(d, [T, C, y]), T.statusCode(v), v = void 0, c && h.trigger(l ? "ajaxSuccess" : "ajaxError", [T, p, l ? f : y]), m.fireWith(d, [T, C]), c && (h.trigger("ajaxComplete", [T, p]), --oe.active || oe.event.trigger("ajaxStop")))
            }

            "object" == typeof t && (n = t, t = void 0), n = n || {};
            var i, o, s, a, u, l, c, f, p = oe.ajaxSetup({}, n), d = p.context || p,
                h = p.context && (d.nodeType || d.jquery) ? oe(d) : oe.event, g = oe.Deferred(),
                m = oe.Callbacks("once memory"), v = p.statusCode || {}, y = {}, b = {}, x = 0, w = "canceled", T = {
            ...
            if (p.data && p.processData && "string" != typeof p.data && (p.data = oe.param(p.data, p.traditional)), B(kt, p, n, T), 2 === x)return T;
            c = oe.event && p.global, c && 0 === oe.active++ && oe.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !Tt.test(p.type), o = p.url, p.hasContent || (p.data && (o = p.url += (vt.test(o) ? "&" : "?") + p.data, delete p.data), p.cache === !1 && (p.url = bt.test(o) ? o.replace(bt, "$1_=" + mt++) : o + (vt.test(o) ? "&" : "?") + "_=" + mt++)), p.ifModified && (oe.lastModified[o] && T.setRequestHeader("If-Modified-Since", oe.lastModified[o]), oe.etag[o] && T.setRequestHeader("If-None-Match", oe.etag[o])), (p.data && p.hasContent && p.contentType !== !1 || n.contentType) && T.setRequestHeader("Content-Type", p.contentType), T.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + Et + "; q=0.01" : "") : p.accepts["*"]);
    ...
    oe.param = function (e, t) {
        ...
        serialize: function () {
            ...
            return this.map(function () {
                ...
                var e = this.type;
                return this.name && !oe(this).is(":disabled") && $t.test(this.nodeName) && !qt.test(e) && (this.checked || !Le.test(e))
            }).map(function (e, t) {
                var n = oe(this).val();
    ...
    var Lt = {0: 200, 1223: 204}, Ht = oe.ajaxSettings.xhr();
    re.cors = !!Ht && "withCredentials" in Ht, re.ajax = Ht = !!Ht, oe.ajaxTransport(function (t) {
        ...
        return re.cors || Ht && !t.crossDomain ? {
            send: function (i, o) {
                ...
                n = function (e) {
                    return function () {
                        n && (n = r = a.onload = a.onerror = a.onabort = a.onreadystatechange = null, "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? o(0, "error") : o(a.status, a.statusText) : o(Lt[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {binary: a.response} : {text: a.responseText}, a.getAllResponseHeaders()))
                    }
    ...
    oe.ajaxSetup({
        ...
        var i, o, s,
            a = t.jsonp !== !1 && (It.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && It.test(t.data) && "data");
        return a || "jsonp" === t.dataTypes[0] ? (i = t.jsonpCallback = oe.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(It, "$1" + i) : t.jsonp !== !1 && (t.url += (vt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function () {
        ...
        "boolean" == typeof t && (n = t, t = !1), t = t || (re.createHTMLDocument ? _.implementation.createHTMLDocument("") : _);
        var r = he.exec(e), i = !n && [];
    ...
    oe.fn.load = function (e, t, n) {
        ...
        offset: function (e) {
            ...
            return o ? (t = o.documentElement, oe.contains(t, r) ? (i = r.getBoundingClientRect(), n = Y(o), {
        ...
        oe.cssHooks[t] = S(re.pixelPosition, function (e, n) {
            return n ? (n = E(e, t), _e.test(n) ? oe(e).position()[t] + "px" : n) : void 0
        })
    ...
    return oe.noConflict = function (t) {
        return e.$ === oe && (e.$ = Mt), t && e.jQuery === oe && (e.jQuery = Ft), oe
    }, t || (e.jQuery = e.$ = oe), oe
